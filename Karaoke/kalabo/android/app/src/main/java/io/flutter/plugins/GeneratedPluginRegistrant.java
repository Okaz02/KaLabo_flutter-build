...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new com.akashskypatel.ffmpeg_kit_extended_flutter.FfmpegKitExtendedFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin ffmpeg_kit_extended_flutter, com.akashskypatel.ffmpeg_kit_extended_flutter.FfmpegKitExtendedFlutterPlugin", e);
    }
    try {
